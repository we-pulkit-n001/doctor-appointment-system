        ...
        <DataTable :value="store.list.data"
            ...
            <Column field="consultation_fees" header="Consultation Fee"
                ...
                <template #body="prop">
                    ...
                    <span>{{ prop.data.doctor ? `$${prop.data.doctor.consultation_fees}` : 'N/A' }}</span>
                </template>
            </Column>
                ...
                <template #body="prop">
                    <div class="p-inputgroup ">
                        ...
                        <Button class="p-button-tiny p-button-danger p-button-text"
                                ...
                                v-if="store.isViewLarge() && !prop.data.deleted_at && permission == 'assignment-can-trash-appointment'"
