...
class DoctorsController extends Controller
{
    ...
    {
        if(!\Auth::user()->hasPermission('assignment-has-access-of-doctor-section'))
        {
    ...
    public function exportDoctorData()
    {
        try{
            return Doctor::exportDoctorData();
        }catch (\Exception $e){
            $response = [];
            $response['success'] = false;
            if(env('APP_DEBUG')){
    ...
    public function importDoctorsData(Request $request)
    {
        try{
            return Doctor::importDoctorsData($request);
        }catch (\Exception $e){
            $response = [];
            $response['success'] = false;
            if(env('APP_DEBUG')){
    ...
    {
        try{
            return Doctor::getUniqueSpecializations();
        }catch (\Exception $e){
            $response = [];
            $response['success'] = false;
            if(env('APP_DEBUG')){
