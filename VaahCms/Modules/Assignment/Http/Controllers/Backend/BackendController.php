...
class BackendController extends Controller
{
    ...
    public function index(Request $request)
    {
         ...
         */
        /*
        $permission_slug = 'has-access-assignment';
        ...
        */
        ...
        return view('assignment::backend.pages.app');
    ...
    public function getAssets(Request $request)
    {
        ...
        */
        ...
        $data['module'] = [
            ...
            'version' => config('settings.global.assignment_version')??config('assignment.version'),
            'is_dev' => config('assignment.is_dev'),
        ];
