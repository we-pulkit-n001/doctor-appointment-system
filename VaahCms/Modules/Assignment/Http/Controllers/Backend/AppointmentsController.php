...
class AppointmentsController extends Controller
{
    ...
    {
        try{
            return Appointment::getDashboardData($request);
        }catch (\Exception $e){
            $response = [];
            $response['success'] = false;
            if(env('APP_DEBUG')){
    ...
    public function exportAppointmentsData()
    {
        try{
            return Appointment::exportAppointmentsData();
        }catch (\Exception $e){
            $response = [];
            $response['success'] = false;
            if(env('APP_DEBUG')){
    ...
    public function importAppointmentsData(Request $request)
    {
        try{
            return Appointment::importAppointmentsData($request);
        }catch (\Exception $e){
            $response = [];
            $response['success'] = false;
            if(env('APP_DEBUG')){
    ...
    {
        try{
            return Appointment::downloadSampleCSV();
        }catch (\Exception $e){
            $response = [];
            $response['success'] = false;
            if(env('APP_DEBUG')){
    ...
    {
        try{
            return Appointment::fetchCustomersCountData($request);
        }catch (\Exception $e){
            $response = [];
            $response['success'] = false;
            if(env('APP_DEBUG')){
